...
def parse_commandline_args():
    ...
    add_isolate_parser.add_argument('-a', '--snapperdb_conf', dest='snapperdb_conf', required=True, help="Snapper3 connection string 'host= dbname= user= password= refgenome= '")
